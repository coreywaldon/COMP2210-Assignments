...
public class ExampleClient {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        URL path = ExampleClient.class.getResource("wordlists/sowpods.txt");
        File f = new File(path.getFile());
        WordLadderGame doublets = new Doublets(new FileInputStream(f));
        ...
        System.out.println(doublets.getMinLadder("place", "eagle"));
    }
}
